...
const Head = ({ title = 'Yuri Katsuki', description = "Hi, I'm Yuri. Senior Dorito Enjoyer from Uzbekistan.", image = defaultOgImage, children }) => {
  ...
  return (
    <NextHead>
      ...
      {/* RSS feed */}
      <link rel="alternate" type="application/rss+xml" title="RSS Feed for katsuki.moe" href="/feed.xml" />
